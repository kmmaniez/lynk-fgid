...
<body>
    ...
    <footer class="fixed-bottom bg-white text-dark text-center py-3">
        <a href="{{ route('discover') }}" class="text-decoration-none fw-semibold text-uppercase text-dark">FGID Indonesia</a>
    </footer>
    @endif
