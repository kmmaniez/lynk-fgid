                ...
                <form id="form" action="{{ route('products.linkstore') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group hstack gap-3 justify-content-between align-items-center">
                        ...
                        <div class="form-input vstack justify-content-around w-100">
                            <input type="text" class="form-control" placeholder="Judul Link" name="name" id="name">
                            <input type="url" class="form-control" placeholder="http://" name="url" id="url">
                        </div>
                    </div>
                    {{-- <div class="box position-relative rounded-2">
                        <img id="displaythumbnail" src="{{ asset('assets/user2.jpg') }}" class="position-relative rounded-1" style="width: 120px; height: 100px;">
                        <a href="#" id="removeimg" class="position-absolute top-0 start-100 translate-middle badge border border-light border-2 rounded-circle bg-danger p-2"><i data-feather="x" class="fa-2"></i></a>
                    </div>  --}}
                    ...
                    <div class="vstack gap-2">
                        <button class="btn btn-md bg-danger bg-gradient text-white fw-semibold text-uppercase w-100 mt-3">Add Link</button>
