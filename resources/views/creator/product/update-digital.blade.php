    ...
    <section id="digital-produk">
        <div class="card border-0 pb-0">
            <div class="card-body">
                ...
                <form action="{{ route('products.digitalupdate', $product->slug) }}" method="post"
                            ...
                            @if ($product->images)
                                @foreach ($product->images as $key => $image)
                                    <div class="item position-relative rounded-2" style="width: max-content;">
                                        ...
                                        @if ($key === 0)
                                            <small id="titlethumb"
                                                class="bg-danger rounded-2 text-white text-center p-1">Thumbnail</small>
                                        @endif
                                    </div>
                                @endforeach
                            @endif
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="description"
                            value="{{ old('description', $product->description) }}" id="description"
                            placeholder="Deskripsi Produk">
                    </div>

                    <div class="mb-3 py-2">
                        <label for="url" class="form-label">Link File/Product</label>
                        <input type="url" class="form-control" value="{{ old('url', $product->url) }}" name="url"
                            id="url" placeholder="drive.google.com/file/fgid">
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" value="{{ old('min_price', $product->min_price) }}"
                                        name="min_price" id="min_price" class="form-control" placeholder="1000"
                    ...
                    <button class="btn bg-danger fw-semibold text-uppercase bg-gradient text-white w-100 mt-3">Update
                        Product</button>
                </form>
                <div class="vstack gap-2 mt-2">
                    <form id="form-delete" action="{{ route('products.digitaldestroy', $product->slug) }}"
                        ...
                        @method('DELETE')
                        <a href="#"
                            class="btn btn-delete btn-md btn-outline-danger fw-semibold text-uppercase w-100">Delete
                            Product</a>
                    </form>
        ...
        $('#images').change(function(e) {
            ...
            for (let index = 0; index < files.length; index++) {
                ...
                reader.addEventListener('load', () => {
                    const img = `
                    <div class="item position-relative" style="width: max-content;">
                        <img id="displayimg" src="${reader.result}" class="rounded-2" width="116" height="118" alt="" srcset="">
